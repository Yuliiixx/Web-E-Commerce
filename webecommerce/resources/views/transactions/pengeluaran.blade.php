...
@section('content')
<div class="container">
    <h2 class="my-4">Daftar Transaksi Pengeluaran</h2>

    <a href="{{ route('transactions.create', ['type' => 'Pengeluaran']) }}" class="btn btn-danger mb-4">Tambah Transaksi Pengeluaran</a>
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            @foreach ($pengeluaranTransactions as $index => $transaction)
                <tr>
                    <td>{{ $index + 1 }}</td>
